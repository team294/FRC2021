 ...
 */
public class TrajectoryBounceSToA3 {
	...
	*/
	public static Trajectory calcTrajectory(FileLog log) {
    	...
    	try {
			...
			log.writeLogEcho(true, "TrajectoryGeneration", "BounceStoA3", 
			...
			trajectory = TrajectoryGenerator.generateTrajectory(
				...
				new Pose2d(2.286, 3.81, new Rotation2d(Math.toRadians(90.0))), config);
