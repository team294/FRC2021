...
public class RobotContainer {
  ...
  public void configureShuffleboard() {
    ...
    SmartDashboard.putData("Drive Trajectory Relative", new DriveFollowTrajectory(CoordType.kRelative, trajectoryCache.cache[TrajectoryType.test.value], false, PIDType.kTalon, driveTrain, log)
        .andThen(() -> driveTrain.tankDrive(0.0, 0.0, false)));
    SmartDashboard.putData("Drive Trajectory Curve Relative", new DriveFollowTrajectory(CoordType.kRelative, trajectoryCache.cache[TrajectoryType.testCurve.value], false, PIDType.kTalon, driveTrain, log)
        .andThen(() -> driveTrain.tankDrive(0.0, 0.0, false)));
